...
<recipetype:extendedcrafting:table>.addShaped("harsh_voidminers_rubetine", 0, <item:voidminersremastered:rubetine>, [
	...
	[<item:divinerpg:realmite_ingot>, <item:oritech:platinum_ingot>, <item:mekanism:ingot_refined_obsidian>, <item:divinerpg:hellstone_ingot>, <item:divinerpg:rupee_ingot>, <item:divinerpg:torridite_ingot>, <item:mekanism:ingot_refined_obsidian>, <item:mekanism:ingot_uranium>, <item:divinerpg:aquatic_ingot>], 
	[<item:minecraft:iron_ingot>, <item:mekanism:ingot_steel>, <item:enderio:dark_steel_ingot>, <item:divinerpg:arlemite_ingot>, <item:twilightforest:wrought_iron_bar>, <item:divinerpg:arlemite_ingot>, <item:enderio:dark_steel_ingot>, <item:mekanism:ingot_steel>, <item:minecraft:iron_ingot>], 
	[<item:divinerpg:realmite_ingot>, <item:mekanism:ingot_uranium>, <item:mekanism:ingot_refined_glowstone>, <item:divinerpg:torridite_ingot>, <item:divinerpg:rupee_ingot>, <item:divinerpg:hellstone_ingot>, <item:mekanism:ingot_refined_glowstone>, <item:oritech:platinum_ingot>, <item:divinerpg:aquatic_ingot>], 
	[<item:extendedcrafting:redstone_ingot>, <item:oritech:duratium_ingot>, <item:enderio:pulsating_alloy_ingot>, <item:mekanism:ingot_lead>, <item:oritech:nickel_ingot>, <item:mekanism:ingot_lead>, <item:enderio:redstone_alloy_ingot>, <item:oritech:adamant_ingot>, <item:extendedcrafting:redstone_ingot>], 
