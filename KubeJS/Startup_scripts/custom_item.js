...
StartupEvents.registry('item', event => {
    event.create('eyes1')
    .tooltip("§4To know one knows nothing, is your first lesson.").color(0, 0xFA2800)
    ...
    .tooltip("§kTo understand.").color(0, 0xF5EB27)
    .displayName("Ingots of Law").color(0, 0xF5EB27)
    .tag('c:ingots')
