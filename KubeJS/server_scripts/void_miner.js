ServerEvents.recipes(event => {
  ...
  event.recipes.voidminersremastered.miner(
  ...
  event.remove({
    id: 'voidminersremastered:overworld/tier1_miner/diamond_ore'
  })
  // Re-add it at a lower weight and with other ore per operation.
  const ores = [
    {
